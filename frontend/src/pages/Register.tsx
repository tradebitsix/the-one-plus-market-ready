...
export default function Register() {
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <p className="text-slate-400 mb-6">Create your first identity.</p>
      ...
      <div className="rounded-2xl border border-slate-800 bg-slate-950/40 p-4">
        ...
        <button className="w-full rounded-lg bg-sky-600 hover:bg-sky-500 px-3 py-2 font-medium"
          onClick={async ()=>{ setErr(null); try { await api.register(email, password, display || undefined); nav('/login'); } catch (e:any) { setErr(e.message || 'Register failed') } }}>
          Create account
        </button>
